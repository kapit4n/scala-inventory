...
class UserSecurity(val userName: String, val rolParam: String, var rolesListParam: List[SecurityRole] = List()) extends Subject {
  ...
  var rolesList: Map[String, List[SecurityRole]] = Map("admin" ->
    List(
      ...
      new SecurityRole("requestRowModule"), new SecurityRole("requestRowModuleCreate"), new SecurityRole("requestRowModuleList"), new SecurityRole("requestRowModuleShow"), new SecurityRole("requestRowModuleEdit"), new SecurityRole("requestRowModuleDelete"),
